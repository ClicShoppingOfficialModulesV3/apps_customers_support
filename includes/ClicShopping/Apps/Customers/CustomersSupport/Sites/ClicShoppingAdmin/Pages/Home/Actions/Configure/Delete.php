<?php
  ...
  class Delete extends \ClicShopping\OM\PagesActionsAbstract
  {
    ...
    public function execute()
    {
      ...
      $CLICSHOPPING_MessageStack->add($CLICSHOPPING_CustomersSupport->getDef('alert_module_uninstall_success'), 'success', 'customers_support');
    ...
    private static function removeMenu()
    {
      ...
      $Qcheck = $CLICSHOPPING_Db->get('administrator_menu', 'app_code', ['app_code' => 'app_customers_customers_support']);
      ...
      if ($Qcheck->fetch()) {
        ...
        $QMenuId->bindValue(':app_code', 'app_customers_customers_support');
        $QMenuId->execute();
        ...
        $CLICSHOPPING_Db->delete('administrator_menu', ['app_code' => 'app_customers_customers_support']);
      }
    }
  }